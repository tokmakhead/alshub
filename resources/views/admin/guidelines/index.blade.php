    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.guidelines.create') }}" 
               class="inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest transition ease-in-out duration-150 shadow-sm"
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium">
                                        <div class="flex gap-2">
                                            ...
                                            <form action="{{ route('admin.guidelines.destroy', $guideline) }}" method="POST" onsubmit="return confirm('Silmek istediğinize emin misiniz?')">
                                                @csrf @method('DELETE')
