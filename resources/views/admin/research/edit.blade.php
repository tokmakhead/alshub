                            ...
                            <div class="space-y-4 border-r pr-6">
                                ...
                                <div>
                                    ...
                                    <div class="p-2 bg-gray-50 border rounded text-sm">
                                        {{ $article->publication_date ? $article->publication_date->format('d.m.Y') : 'Bilinmiyor' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center border-b pb-2">
                                    ...
                                    <button type="button" 
                                            ...
                                            style="background-color: #9333ea; color: white; padding: 5px 12px; border-radius: 4px; border: none; font-weight: bold; font-size: 11px; cursor: pointer;">
                                        🪄 AI ile Hazırla
                                    </button>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="turkish_title" value="{{ old('turkish_title', $article->turkish_title) }}" class="w-full rounded border-gray-300 text-sm font-bold">
                                </div>

                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase">Türkçe Özet & Notlar</label>
                                    <textarea id="abstract_tr" name="abstract_tr" rows="20" class="w-full rounded border-gray-300 text-sm">{{ $article->abstract_tr }}</textarea>
                                </div>
